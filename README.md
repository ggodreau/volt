...
1. Step 1: Download Windows 10 Media Creation Tool and VMware Workstation (00:00)
...
1. Step 2: Open Windows 10 Media Creation Tool and download Windows 10 ISO (00:30)
...
1. Step 5: Power on the virtual machine and set up Windows (04:26)
...
1. Step 6: Configure display settings (optional) (07:31)

* Go to system settings and find the display settings.
  * Do this if you need to change the resolution or make text larger

1. Step 7: Log in to ACDelco TDS and download Techline Connect (08:18)
...
1. Step 8: Download and install VX Manager (09:43)

* Go to the [VXDiag website](https://www.vxdiagshop.com/info/download/) and find the download page.
  * Edit: People are reporting problems with the latest version of VX Manager. However, the 1.8.4 version appears to still work. If you have this problem or want to avoid it, [this link](http://blog.vxdiagshop.com/2021/03/17/free-download-vx-manager-v1-8-4-0315/) includes the download for the 1.8.4 version.
...
1. Step 9: Set up VX Manager (12:52)
...
1. Step 10: Install Techline Connect (14:28)
...
1. Step 11: Prepare for vehicle programming (18:36)
...
1. Step 12: Reprogram the Battery Energy Control Module (19:59)
...
1. Step 13: Reprogram the Hybrid Powertrain Control Module 2 (21:27)
